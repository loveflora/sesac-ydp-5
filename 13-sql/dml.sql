...
-- 총 주문액이 10000원 이상인 고객에 대해, 고객 별로 주문한 상품의 총 수량 구하기
...
-- 총 주문액이 10000원 이상인 고객에 대해 고객 별로 주문한 상품 총 수량 구하기
...
-- ! group by 주의사항 !
-- select 절에서는 group by에서 사용한 속성과 집계함수만 사용 가능
-- 고객 별로 주문한 주문 건수 구하기
select custid, count(*) from orders group by custid;
